...
export async function init({api,node,message}){
 ...
 function render(){form.replaceChildren();form.append(node('h2','照片與背景'));photo(form,'image','主照片');photo(form,'backgroundImage','頁面背景照片');const grid=node('div');grid.className='form-grid';form.append(grid);
