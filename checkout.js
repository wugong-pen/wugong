...
$('submitOrder').addEventListener('click',async()=>{
  ...
  try{const order={customer:{name:$('name').value,phone:$('phone').value,address:$('address').value,country:$('country').value,phone:$('phone').value},shipping:$('shipping').value,payment:document.querySelector('input[name=payment]:checked').value,note:$('note').value,items,expectedTotal,coupon:couponCode,firstCoupon:firstCouponCode};
