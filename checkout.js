...
const couponPanel=document.createElement('div');couponPanel.innerHTML='<label for="checkoutCoupon">優惠券折扣碼</label><input id="checkoutCoupon" maxlength="40"><button type="button" id="applyCoupon">套用／清除優惠券</button><p id="couponSummary"></p><p id="firstGiftSummary" role="status"></p><p>一般優惠券：輸入折扣碼後按套用，每張訂單限一張。首購鋼筆贈品會依實際收件國家自動套用，不需領券或輸入代碼。</p>';
